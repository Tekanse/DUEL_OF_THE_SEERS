	...
	(
		{
			...
			(
					...
					(
						...
						{ 
							...
							(
								...
								{ "name" : "player2_name_text", "type":"text", "x":0, "y":0, "text": uiScriptLocale.BNW_GAME_UI_COM, "all_align" : "center", "color" : 0xFFD4D4D4, },
							),
						},
						## player2 score
						{ 
				...
				## player1 cross img
				{ "name" : "player1_card0_cross", "type" : "image", "x" : 30,  "y" : 263, "image" : ROOT + "cross_mark.sub"},			
				{ "name" : "player1_card1_cross", "type" : "image", "x" : 51,  "y" : 211, "image" : ROOT + "cross_mark.sub"},
				{ "name" : "player1_card2_cross", "type" : "image", "x" : 72,  "y" : 263, "image" : ROOT + "cross_mark.sub"},
				{ "name" : "player1_card3_cross", "type" : "image", "x" : 93,  "y" : 211, "image" : ROOT + "cross_mark.sub"},
				{ "name" : "player1_card4_cross", "type" : "image", "x" : 114, "y" : 263, "image" : ROOT + "cross_mark.sub"},
				{ "name" : "player1_card5_cross", "type" : "image", "x" : 135, "y" : 211, "image" : ROOT + "cross_mark.sub"},
				{ "name" : "player1_card6_cross", "type" : "image", "x" : 156, "y" : 263, "image" : ROOT + "cross_mark.sub"},
				{ "name" : "player1_card7_cross", "type" : "image", "x" : 177, "y" : 211, "image" : ROOT + "cross_mark.sub"},
				{ "name" : "player1_card8_cross", "type" : "image", "x" : 198, "y" : 263, "image" : ROOT + "cross_mark.sub"},
				
							
				## player2 card
				{ "name" : "player2_card0", "type" : "image", "x" : 30, "y" : 42, "image" : ROOT + "back_black.sub"},
				{ "name" : "player2_card1", "type" : "image", "x" : 51, "y" : 94, "image" : ROOT + "back_white.sub"},
				{ "name" : "player2_card2", "type" : "image", "x" : 72, "y" : 42, "image" : ROOT + "back_black.sub"},
				{ "name" : "player2_card3", "type" : "image", "x" : 93, "y" : 94, "image" : ROOT + "back_white.sub"},
				{ "name" : "player2_card4", "type" : "image", "x" : 114, "y" : 42, "image" : ROOT + "back_black.sub"},
				{ "name" : "player2_card5", "type" : "image", "x" : 135, "y" : 94, "image" : ROOT + "back_white.sub"},
				{ "name" : "player2_card6", "type" : "image", "x" : 156, "y" : 42, "image" : ROOT + "back_black.sub"},
				{ "name" : "player2_card7", "type" : "image", "x" : 177, "y" : 94, "image" : ROOT + "back_white.sub"},
				{ "name" : "player2_card8", "type" : "image", "x" : 198, "y" : 42, "image" : ROOT + "back_black.sub"},
