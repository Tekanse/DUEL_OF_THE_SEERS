//To GC packets add (you may need to change number if its already taken, but it need to match serverside):
	HEADER_GC_MINIGAME_BNW			= 171,


//To CG packets add (you may need to change number if its already taken, but it need to match serverside):
